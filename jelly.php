<?php
	 ...
	 * Requires PHP 7.4
	 * Author: Chad Milburn and Jonathan Clark
	 * Author URI: http://lumne.net
	 * License: GPL2

	 Copyright 2021  Lumne  (email : jonathan@lumne.net)
	...
	*/
	...
	function jelly_images(array $args){
		...
		echo '<td><input type="button" id="new_image" class="image-button" value="New image" data-count="'.$c.'" /></td>'; // Warning: Undefined variable $c
		echo '</table>';
	}
	...
	function jelly_output($atts,$content=NULL){
		...
		$output = '<div class="jelly'.($active?' active':'').'" id="gallery'
